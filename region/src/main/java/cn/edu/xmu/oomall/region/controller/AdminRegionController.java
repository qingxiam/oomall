...
public class AdminRegionController {
    ...
    public ReturnObject getShopSubRegionsById(@PathVariable Long did, @PathVariable Long id,
        ...
        return new ReturnObject(new PageDto<>(regionList.stream().map(o -> IdNameTypeVo.builder().id(o.getId()).name(o.getName()).build()).collect(Collectors.toList()), page, pageSize));
    }
