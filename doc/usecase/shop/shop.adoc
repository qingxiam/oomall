...
罗芳魁
include::staff-mgt/MALL-SHOP-012-QueryStaffAccount.adoc[]
=== 3.3.7 管理服务
...
罗芳魁
include::servicecontract-mgt/MALL-SERVICE-005-QueryServiceProvider.adoc[]
...
image::商户-管理售后.png[]
罗芳魁
include::aftersale-mgt/MALL-AFTERSALE-002-ReviewAftersales.adoc[]
