...
public class ShopService {
     ...
     * @task 2023-dgn1-007
     */
    public Shop createShop(Shop shop, UserToken user){
     ...
     * @task 2023-dgn1-007
     */
    public void updateShop(Shop shop, UserToken user){
     ...
     * @task 2023-dgn1-007
     */
    public void onlineShop(Long shopId, UserToken userToken){
        Shop shop = this.shopDao.findById(shopId);
        shop.online(userToken);
    }
     ...
     * @task 2023-dgn1-007
     */
    public void offlineShop(Long shopId, UserToken userToken){
        Shop shop = this.shopDao.findById(shopId);
        shop.offline(userToken);
    }
     ...
     * @task 2023-dgn1-007
     */
    public void updateShopAudit(Long shopId, UserToken userToken, Boolean conclusion){
        if (conclusion) {
            Shop shop = this.shopDao.findById(shopId);
            shop.approved(userToken);
        }
    }
     ...
     * @task 2023-dgn1-007
     */
    public void deleteShop(Long id, UserToken userToken){
        Shop shop = this.shopDao.findById(id);
        shop.abandon(userToken);
    }
